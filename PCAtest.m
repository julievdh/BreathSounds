...
[U,summary,AR,SR] = pca2(BREATHONLY(ON,1:12),1);
...
%% FIND INDICES
kolohe = find(BREATHONLY(ON,13) == 1);
liko = find(BREATHONLY(ON,13) == 2);
lono = find(BREATHONLY(ON,13) == 3);
nainoa = find(BREATHONLY(ON,13) == 4);

before = find(BREATHONLY(ON,14) == 1);
after = find(BREATHONLY(ON,14) == 2);
deck = find(BREATHONLY(ON,14) == 3);
water = find(BREATHONLY(ON,14) == 4);
swim = find(BREATHONLY(ON,14) == 5);

BOAT = find(BREATHONLY(ON,15) > 14 & BREATHONLY(ON,15) < 17);
NOBOAT = find(BREATHONLY(ON,15) < 15 | BREATHONLY(ON,15) > 16);

SARASOTA = find(BREATHONLY(ON,17) == 2);
DQO = find(BREATHONLY(ON,17) == 1);
