dr = cd; 
warning off 
load([dr(1:40) 'DQ/DQ2013/tagdatafromalex/tt13_288a01_var.mat'])
tag = 'tt13_288a';
load('tt13_288a_PQ')
R = loadaudit(tag);
%%
...
Qb = Quality-20; Qb(Qb == 2) = 1; % make it binomial
...
keep dr
load([dr(1:40) 'DQ/DQ2013/tagdatafromalex/tt13_271b01_var.mat'])
tag = 'tt13_271b';
load('tt13_271b_PQ')
R = loadaudit(tag);
