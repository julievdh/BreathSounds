...
maxenv(k) = max(y(peakwindowsize:k));							
end
...
% figure(2)
% clear flow
% flow(:,1) = alldata(ii(51):ii(end),1)-alldata(ii(51,1));
% flow(:,2) = alldata(ii(51):ii(end),2);
% plotyy(t,averageenv,flow(:,1),flow(:,2))
